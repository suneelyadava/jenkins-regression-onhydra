...
def DUT = 'esx-06'
def NETQ_ENV='/mnt/behemoth1/NETQ-JENKINS/Repo/Dev/netq_dev_ova_only_netq_onprem_ts.yaml'
def LOGLEVEL = 'DEBUG'
...
def TESTDIR = '$RUNDIR/cl-tests/tests/netq/netq_trace_unit_test.py'
...
node("hydra-03"){
    ...
    if(build_ok){
        ...
        mail bcc: '', body: "http://sm-telem-04.lab.cumulusnetworks.com:8080/job/Regression-On-Hydra/", cc: 'syadava@nvidia.com, anurag@nvidia.com, mrns@nvidia.com, sriharsha@nvidia.com', from: 'syadava@nvidia.com', replyTo: '', subject: 'NETQ Trace Test Results Failed with->CumulusLinux3.7.X', to: 'syadava@nvidia.com'
    }

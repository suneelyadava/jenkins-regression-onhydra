...
node("hydra-03"){
    ...
    try{
        stage('Running CL4 Agent Sanity ......'){
    ...
    if(build_ok){
        ...
        mail bcc: '', body: "http://sm-telem-04.lab.cumulusnetworks.com:8080/job/netq-agent-sanity-cl4/", cc: 'syadava@nvidia.com, anurag@nvidia.com, mrns@nvidia.com, sriharsha@nvidia.com, nagachandra@nvidia.com', from: 'syadava@nvidia.com', replyTo: '', subject: 'Test Results -- Pipeline Agent Sanity-CL-4x is Failed!', to: 'syadava@nvidia.com'
    }
